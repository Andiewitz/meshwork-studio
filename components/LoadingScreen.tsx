...
export const LoadingScreen: React.FC<LoadingScreenProps> = ({ 
  ...
  return (
    <div className={`${fullScreen ? 'fixed inset-0 z-[100] bg-[#fdfbf7]' : 'h-full w-full min-h-[400px] flex items-center justify-center bg-transparent'} flex items-center justify-center overflow-hidden`}>
         ...
         <div className="relative bg-white border-2 border-slate-900 p-8 rounded-2xl shadow-[8px_8px_0_0_#0f172a] flex flex-col items-center gap-8 max-w-sm w-full mx-4 animate-in zoom-in-95 duration-300">
            ...
            <div className="relative w-20 h-20">
                {/* Static Ghost */}
                <div className="absolute inset-0 bg-indigo-50 rounded-xl border-2 border-indigo-200 transform rotate-45"></div>
                
                {/* Spinning Element */}
                <div className="absolute inset-0 bg-indigo-600 rounded-xl animate-spin shadow-sm z-10" style={{ animationDuration: '3s' }}></div>
            ...
            <div className="flex flex-col items-center gap-2 text-center z-20">
                ...
                <div className="flex items-center gap-2 px-3 py-1 bg-indigo-50 rounded-full border border-indigo-200">
                    ...
                    <span className="text-indigo-600 text-xs font-mono font-bold uppercase tracking-widest">
                        {message}
                    </span>
                </div>
            </div>
